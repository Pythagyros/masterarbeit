...
%	cleardoublepage=empty,
	...
	%toc=bib, index=totoc,
	toc=listof,					
	listof=flat,			% treats list of figures/tables like a table and increases width between number and title
	%report,
	toc=bibliography,		% bibliography is added to the table of contents
	% setcapindent,
	% titlepage=true,
	english
]{scrreprt}
