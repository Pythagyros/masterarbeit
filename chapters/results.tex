...
Five different mobile phases were employed to compare separation on silica 60 F\textsubscript{254} TLC plates (see Section~\ref{sub:thin_layer_chromatography}).
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{tlc_scheme}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{tlc_results}
...
Staining of the analytical sides revealed, that the reverse liquid culture extract does not contain a significant amount of pentoses to adopt the blue color seen in the ribose sample.
...
Bio-Gel P-2 has a fractionation range of 100--1800~Da and was chosen for separation with water as the mobile phase.
...
\begin{minipage}{\textwidth}
	\paragraph*{ToDo}
	\begin{itemize}
		\item Antibiotics smaller than 100~Da?
		\item Antibiotics larger than 1800~Da?
		\item other explanations for low retention
	\end{itemize}
\end{minipage}}
...
Both liquid culture extracts and agar plaques of Tü2401 were subject to the \emph{yorB}-assay to determine the presence of the putative \emph{yorB} inducer in extracts of liquid culture.
