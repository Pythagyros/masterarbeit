...
\begin{table}[htbp]
	\caption[Media components for the cultivation of strain Tü2401]{%
		...
		Amounts are given for preparation with one liter of MilliQ-\ch{H2O}.
...
Bio-Gel P-2 polyacrylamide beads (BIO RAD) with a fractionation range of 100--1800~Dalton (Da) were used for gel filtration experiments.
