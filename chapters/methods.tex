...
\label{sec:chemicals_&_instruments}
	...
	\begin{table}[htbp]
		\caption{\textbf{Used chemicals and solvents}}
	...
	\begin{table}[htbp]
		\caption{\textbf{Components of HPLC systems}}
		\label{tab:HPLCtab}
		\centering
		\begin{tabularx}{\textwidth}{XXX}
			\toprule
	...
	\begin{table}[htbp]
		\caption{\textbf{Column Specifications}}
		...
		\centering
			\begin{tabularx}{\textwidth}{XXXX}
				...
				Phenomenex & Luna\textsuperscript{\textregistered} & NH\textsubscript{2} \SI{5}{\micro\meter} & 250 $\times$ 4.6 mm \\
