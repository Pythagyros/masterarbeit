...
\label{sec:strain_cultivation}
	...
	All media were prepared by solving the components listed in Table~\ref{tab:media_components} in MilliQ-\ch{H2O} and adjusting the pH with \ch{NaOH} and \ch{HCl}. For solid media, 2~\% (w/v) agar was added. Sterilization was performed by autoclaving at \SI{121}{\celsius} and \SI{100000}{\kilo\pascal} for \SI{15}{\minute}. Fluid media were stored at ambient temperature, solid media at \SI{8}{\celsius}.
...
% section chromatographic_methods (end)
	...
	\subsection{Time-based fractionation by HPLC} % (fold)
	\label{sub:hilic}

	Culture extracts of strain T\"u2401 were fractioned via HPLC coupled to an automated fraction collector.
