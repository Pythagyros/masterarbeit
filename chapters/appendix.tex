...
\label{sec:hplc_methods}
	...
	\begin{table}[htbp]
		\caption{\textbf{Standard Screening Method}}
	...
	\begin{table}[htbp]
		\caption{Standard aminocolumn method}
	...
	\begin{table}[htbp]
		\caption{\textbf{The standard HILIC method}}
	...
	\begin{table}[htbp]
		\caption{\textbf{HILIC method adapted for MS coupling}}
	...
	\begin{table}[htbp]
		\caption{\textbf{Screening method for HPLC-MS}}
	...
	\begin{table}[htbp]
		\caption{\textbf{Screening Method Polar-C18}}
		\label{tab:method_c18_screening}
		\centering
		\begin{tabularx}{\textwidth}{XX}
			\toprule
	...
	\begin{table}[htbp]
		\caption{\textbf{Reverse Screening Method Polar-C18}}
		\label{tab:method_c18_screening}
		\centering
		\begin{tabularx}{\textwidth}{XX}
			\toprule
